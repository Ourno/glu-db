...
pkgdatadir = $(datadir)/glu_pr2_db
pkgincludedir = $(includedir)/glu_pr2_db
pkglibdir = $(libdir)/glu_pr2_db
pkglibexecdir = $(libexecdir)/glu_pr2_db
...
OBJEXT = o
PACKAGE = glu_pr2_db
PACKAGE_BUGREPORT = johndoe at example.com
PACKAGE_NAME = glu_pr2_db
PACKAGE_STRING = glu_pr2_db 1.0
PACKAGE_TARNAME = glu_pr2_db
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
POW_LIB = 
